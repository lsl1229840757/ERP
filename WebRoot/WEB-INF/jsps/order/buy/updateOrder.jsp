			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="648px">
							<s:select id="supplierSelect" headerKey="" name="order.supplier.supplierId" headerValue="请选择" list="#suppliers" cssClass="kuan" cssStyle="width:300px;" listKey="supplierId" listValue="name"></s:select>
					...
					<s:iterator value="order.details" var="detail">
						<tr id="defaultTr" align="center" bgcolor="#FFFFFF">
							<td height="30">
								...
								<s:select name="#detail.product.productType.productTypeId" listKey="productTypeId" listValue="name" list="#detail.product.productType.supplier.pts" cssClass="goodsType" cssStyle="width:200px" ></s:select>
							</td>
							<td>
							...
							<td><input name="detailNum" class="num order_num" style="width:67px;border:1px solid black;text-align:right;padding:2px" type="text" value="<s:property value="#detail.detailNum"/>"/>
							</td>
							<td>
							<input name="detailPrice" class="prices order_num" style="width:93px;border:1px solid black;text-align:right;padding:2px" type="text" value="<s:property value="#detail.detailPrice"/>"/> 元</td>
							<td class="total" trPrice="<s:property value="#detail.detailNum * #detail.detaiPrice"/>" align="right"><s:property value="#detail.detailNum * #detail.detailPrice"/>&nbsp;元</td>
							<td>
