...
<script type="text/javascript">
	$(function() {
		...
		$("#updateEmpForm").find("[regr]").keyup(function() {
			var val = $(this).val();
		...
		$("#updateEmpForm").find("[reg]").keyup(function() {
			var val = $(this).val();
	...
	function validateForm() {
	    var flag = true;
		//获取regr的属性节点,要加[]
		$("#updateEmpForm").find("[regr]").each(function() {
			//取值
			var val = $(this).val();
			var regex = new RegExp($(this).attr("regr"));
		...
		//再检验非必须项目
		$("#updateEmpForm").find("[reg]").each(function() {
			var val = $(this).val();
			var tip = $(this).attr("tip");
...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="updateEmpForm" action="ajax_emp_update" method="post">
				<div style="border:1px solid #cecece;">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr bgcolor="#FFFFFF">
							...
							<td width="32%">
								<!-- 这里的regr的r表示必填项目,\w表示匹配字母数字和下划线 --> 
								<s:textfield type="text" size="25" name="emp.username" regr="^\w{6,8}$" tip="请输入6到8位用户名"></s:textfield>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td><s:textfield type="text" size="25" name="emp.birthday" onfocus="c.showMoreDay=false;c.show(this);" readonly="true" /></td>
